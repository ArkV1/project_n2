...
class DatabaseManagerDialog extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<DatabaseManagerDialog> createState() =>
      _DatabaseManagerDialogState();
}
                            ...
                            if (currentDirectory.hasValue) {
                              ...
                              final params = SaveFileDialogParams(
                                sourceFilePath: path.join(
                                    docsDir.path, "objectbox", "data.mdb"),
                              );
                            ...
                            child: Row(
                              ...
                              children: [
                                currentDirectory.when(
                                  data: (docsDir) {
                                    final size = File(
                                      path.join(docsDir.path, "objectbox",
                                          "data.mdb"),
                                    ).lengthSync();
                                    return Column(
                                      mainAxisAlignment:
            ...
            if (imported != null)
              Expanded(
                child: TextButton(
                    ...
                    onPressed: () async {
                      await ObjectBox()
                          .databaseOverwrite(imported!.readAsBytesSync())
                          .then(
                        (_) {
