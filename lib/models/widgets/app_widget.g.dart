...
String _$appWidgetsHash() => r'76c04cadf15935ac994f2125de56ae481918eb23';

/// See also [AppWidgets].
@ProviderFor(AppWidgets)
final appWidgetsProvider =
    AutoDisposeAsyncNotifierProvider<AppWidgets, List<AppWidget>>.internal(
  AppWidgets.new,
...
typedef _$AppWidgets = AutoDisposeAsyncNotifier<List<AppWidget>>;
