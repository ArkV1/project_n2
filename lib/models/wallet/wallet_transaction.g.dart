...
const WalletTransactionSchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'wallets': LinkSchema(
      id: -5232059247332169876,
      name: r'wallets',
      target: r'Wallet',
      single: false,
      linkName: r'transactionsLink',
    )
  },
  embeddedSchemas: {},
...
extension WalletTransactionQueryLinks
    on QueryBuilder<WalletTransaction, WalletTransaction, QFilterCondition> {
  QueryBuilder<WalletTransaction, WalletTransaction, QAfterFilterCondition>
      wallets(FilterQuery<Wallet> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'wallets');
    });
  }
  ...
  QueryBuilder<WalletTransaction, WalletTransaction, QAfterFilterCondition>
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'wallets', length, true, length, true);
    });
  }
  ...
  QueryBuilder<WalletTransaction, WalletTransaction, QAfterFilterCondition>
      walletsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'wallets', 0, true, 0, true);
    });
  }
  ...
  QueryBuilder<WalletTransaction, WalletTransaction, QAfterFilterCondition>
      walletsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'wallets', 0, false, 999999, true);
    });
  }
  ...
  QueryBuilder<WalletTransaction, WalletTransaction, QAfterFilterCondition>
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'wallets', 0, true, length, include);
    });
  }
  ...
  QueryBuilder<WalletTransaction, WalletTransaction, QAfterFilterCondition>
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'wallets', length, include, 999999, true);
    });
  }
  ...
  QueryBuilder<WalletTransaction, WalletTransaction, QAfterFilterCondition>
    ...
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(
          r'wallets', lower, includeLower, upper, includeUpper);
    });
  }
}
...
extension WalletTransactionQueryWhereDistinct
  ...
  QueryBuilder<WalletTransaction, WalletTransaction, QDistinct> distinctByName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension WalletTransactionQueryProperty
  ...
  QueryBuilder<WalletTransaction, String?, QQueryOperations> amountProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<WalletTransaction, String?, QQueryOperations> nameProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'name');
    });
  }

  QueryBuilder<WalletTransaction, DateTime?, QQueryOperations>
  ...
  QueryBuilder<WalletTransaction, int, QQueryOperations> walletIdProperty() {
    return QueryBuilder.apply(this, (query) {
