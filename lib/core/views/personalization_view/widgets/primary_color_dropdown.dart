...
class PrimaryColorDropdown extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    String primaryColorListDropdownValue = ref.watch(themeManagerProvider).primaryColor['color'];
    ...
    return DropdownButtonFormField<String>(
      ...
      items: primaryColorList.map<DropdownMenuItem<String>>((Map<String, dynamic> map) {
