...
mixin _$AppWidget {
  ...
  int get containedObjectId => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      containedObjectTypeIndex: null == containedObjectTypeIndex
          ...
          : containedObjectTypeIndex // ignore: cast_nullable_to_non_nullable
              as int,
      containedObjectId: null == containedObjectId
          ? _value.containedObjectId
          : containedObjectId // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$AppWidgetImpl extends _AppWidget with DiagnosticableTreeMixin {
  _$AppWidgetImpl(
      ...
      required this.containedObjectId,
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AppWidget(id: $id, parentId: $parentId, parentIndex: $parentIndex, containedObjectTypeIndex: $containedObjectTypeIndex, containedObjectId: $containedObjectId, widgetTypeIndex: $widgetTypeIndex, widgetSettingsMap: $widgetSettingsMap)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('containedObjectId', containedObjectId))
      ..add(DiagnosticsProperty('widgetTypeIndex', widgetTypeIndex))
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(
                ...
                other.containedObjectTypeIndex == containedObjectTypeIndex) &&
            (identical(other.containedObjectId, containedObjectId) ||
                other.containedObjectId == containedObjectId) &&
...
abstract class _AppWidget extends AppWidget {
  factory _AppWidget(
      ...
      required final int containedObjectId,
